package br.com.mrocha.converter;
...
@Named
@FacesConverter(value = "clienteConverter", forClass = ClienteConverter.class)
public class ClienteConverter implements Converter {

private static final String key = "br.com.mrocha.converter.ClienteConverter";
